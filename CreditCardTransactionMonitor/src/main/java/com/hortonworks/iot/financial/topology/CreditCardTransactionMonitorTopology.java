...
public class CreditCardTransactionMonitorTopology {
	 public static void main(String[] args) {
	     ...
	     // Use pipe as record boundary
	      ...
	      incomingTransactionsKafkaSpoutConfig.scheme = new SchemeAsMultiScheme(new TransactionEventJSONScheme());
	     ...
	     /*SimpleHBaseMapper accountMapper = new SimpleHBaseMapper()
	      ...
	      builder.setBolt("EnrichTransaction", new EnrichTransaction(), 1).shuffleGrouping("IncomingTransactionsKafkaSpout");      
